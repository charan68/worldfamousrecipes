...
$.ajax({
    type: 'get',
    url: `https://www.themealdb.com/api/json/v1/1/filter.php?a=Moroccan`,
    success: function(response){
        console.log(response);
        for(let i=0;i<response.meals.length;i++){
            let newitem = `<div data-aos="fade-right"
            data-aos-offset="300"
            data-aos-easing="ease-in-sine" class="col-md-3 m-2 shadow-lg p-3 mb-5 bg-white rounded text-center">
